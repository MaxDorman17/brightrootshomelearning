...
def add_book(
    ...
    book = ReadingLog(
        ...
        completed_chapters=book_in.completed_chapters or 0,
        reading_journal=book_in.reading_journal,
        question_1_answer=book_in.question_1_answer,
        question_2_answer=book_in.question_2_answer,
        question_3_answer=book_in.question_3_answer,
